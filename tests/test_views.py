...
class TestApi(unittest.TestCase):
    ...
    def test_post_a_parcel(self):
        ...
        response = self.client.post(
            self.hostname+'parcels', data=json.dumps(parcels))
    ...
    def test_get_specific_parcel_by_parcelId(self,parcelId):
    ...
    def test_parceId_is_int(self,parcelId):
        parcelId = "str"
        self.assertFalse(add_parcel_delivery_order(parcelId),False)
